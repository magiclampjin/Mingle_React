...
const ReportReplyModal = ({ isOpen, onRequestClose, contentLabel, replyId }) => {
    ...
    const handleReport = () => {
        ...
        axios.post(`/api/reply/report/${replyId}`, formData) // 신고 API 업데이트 필요
            .then(response => {
                alert("신고가 접수되었습니다.")
            })
            .catch(error => {
        ...
        >
            <div className={styles.modalBody}>
                ...
                <div className={styles.reportDisclaimer}>
                    댓글 신고는 밍글 이용수칙에 맞지 않는 댓글을 신고하는 기능입니다.

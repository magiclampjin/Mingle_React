      ...
      {selectParty ? (
        <div className={style.body}>
          ...
          <div className={style.serviceName}>
            <div className={`${style.leftContent} ${style.colorGray}`}>
              이용 서비스
            </div>
          ...
          <div className={style.servicePeriod}>
            ...
            <div className={`${style.rightContent}`}>
              ...
              {getEndDate(selectParty.startDate, selectParty.monthCount)}{" "}
            </div>
          </div>
          ...
          <div className={style.partyPrice}>
            ...
            <div className={style.contentCover}>
              <div className={style.leftContent}>
                파티 분담금 <span className={style.colorGray}>(월)</span>
              </div>
              <div className={style.rightContent}>
                {formatNumber(
            ...
            <div className={style.contentCover}>
              <div className={style.leftContent}>
                밍글 수수료{" "}
                <span className={style.colorGray}>(월, VAT 포함)</span>
              </div>
            ...
            <div className={style.subTitle}>
              파티 보증금{" "}
              <span className={style.colorGray}>
                (최초 1회, 파티 종료 시 100% 환급)
              </span>
            </div>
            <div className={style.contentCover}>
              <div className={style.leftContent}>

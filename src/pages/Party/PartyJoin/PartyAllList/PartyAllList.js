                ...
                {   
                    isServiceListLoading ? (
                        ...
                        service.map((e,i)=>{  
                            ...
                            return(
                                <>
                                    <div key={i} data-id={e.id} className={joinPossible?`${style.partyContent}`:`${style.partyContent} ${style.cantSelectContent}`} onClick={joinPossible?handleSelectService:()=>{alert("이미 가입한 서비스의 파티입니다.\n추가 가입은 불가능합니다.");}}>
